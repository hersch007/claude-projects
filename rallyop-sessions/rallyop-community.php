...
<script id="rallyop-community-placement-script">(function(){var box=document.getElementById('rallyop-community'),footer=document.querySelector('footer');if(box&&footer&&box.parentNode===document.body)footer.parentNode.insertBefore(box,footer);})();</script>
