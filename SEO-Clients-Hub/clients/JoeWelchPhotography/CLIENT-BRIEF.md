...
**Engagement terms (confirmed 2026-09-14):** Website + SEO Support plan, $99/mo for a 12-month term, then $59/mo starting year two. No separate setup fee. Richard implements changes directly (on-page SEO, technical SEO, schema, GBP, page additions) once given site/GBP access; anything needing Joe's voice or approval is sent to him as drafted copy/recommendations rather than published unilaterally.
