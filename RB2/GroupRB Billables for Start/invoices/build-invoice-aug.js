...
const RATE = 40;
const items = [
  { client: 'Garlock',      hours: 44.50 },
  { client: 'Fruth',        hours: 43.75 },
  { client: 'MISC',         hours: 31.50 },
  { client: 'Advernology',  hours: 26.00 },
  { client: 'TriCoGo',      hours: 6.25  },
  { client: 'Automotive Service Products', hours: 1.00 },
  { client: 'Click Broadband', hours: 0.50 },
].map(i => ({ ...i, rate: RATE }));
...
const rows = items.map(i => `
      <tr>
        <td>${i.client} — App Development, Marketing, SEO &amp; Web Services — August 2026</td>
...
<head>
<meta charset="utf-8">
<title>Invoice GRB-2026-09</title>
<style>
  * { box-sizing: border-box; }
  ...
  tbody td { padding: 6px 12px; border-bottom: 1px solid #e3e0ea; }
  tbody tr:nth-child(even) { background: #f8f7fb; }
  tfoot td { padding: 7px 12px; font-weight: 700; }
  tfoot tr.grand td { border-top: 2px solid #4a3f6b; font-size: 15px; color: #4a3f6b; }
  .footer { margin-top: 18px; padding-top: 10px; border-top: 1px solid #e3e0ea; font-size: 11px; color: #666; }
</style>
</head>
<body>
  <div class="top">
    ...
    <div class="invoice-title">
      <h1>INVOICE</h1>
      <div class="meta"><strong>Invoice #:</strong> GRB-2026-09</div>
      <div class="meta"><strong>Invoice Date:</strong> 9/4/2026</div>
      <div class="meta"><strong>Period:</strong> August 1&ndash;31, 2026</div>
    </div>
  </div>
...
fs.writeFileSync('invoices/GroupRB-Invoice-2026-09.html', html);
