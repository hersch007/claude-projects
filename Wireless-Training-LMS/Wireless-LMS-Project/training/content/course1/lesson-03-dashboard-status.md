...
**Version:** 1.0 | 2026
**Preceding Lesson:** Lesson 2 â€” User Roles and Responsibilities
**Following Lesson:** Lesson 4 â€” The Project Information Form (PIF)
...
- Every project status â€” what it means, what color it displays, and who needs to act
...
Once a user logs into AMP, the first thing they see is the Dashboard. This is the control center for the entire application process â€” the place where every active project is visible, every status is tracked, and every required action is identified.
...
In AMP, every wireless facility application is organized as a **project**. A project represents a single request â€” from initial application submission all the way through final inspection and approval.
...
- Review history â€” every action taken, every comment made, every decision recorded
- Communication between Agent, Analyst, and Jurisdiction

> **Key Point:** Projects are the central unit of work in AMP. Everything â€” status, components, communications, fees, and approvals â€” is organized around individual projects.

### What a Project Tracks

A project does not just store data â€” it actively tracks the lifecycle of an application through defined stages:

1. **Creation** â€” Agent initiates the project and begins the PIF
2. **Submission** â€” Agent submits the completed PIF for review
3. **Review** â€” Analyst and/or Jurisdiction reviews the application
4. **Revision** â€” If corrections are needed, the project is sent back; Agent revises and resubmits
5. **Approval** â€” Jurisdiction approves; components unlock and the process continues
6. **Construction** â€” Permit issued; construction begins and is tracked
7. **Final Inspection** â€” On-site verification that the project was built as approved
8. **Completion** â€” Project is closed in AMP; all records stored in the Official Record
...
> *Caption: The AMP Dashboard â€” the first screen after login. Every active project appears here with real-time status.*
...
- **Project ID** â€” the WTS-assigned unique identifier
- **Project Type** â€” what kind of application this is
- **Jurisdiction** â€” which local government is reviewing it
- **Agent** â€” who submitted it
- **Component status columns** â€” the current status of each component (PIF, NCM, etc.) shown in color
- **Shot Clock** â€” federal deadline countdown showing days remaining for Jurisdiction review
- **Last Activity** â€” when the most recent action occurred
...
## Project Status â€” Complete Reference
...
| Completed | Green | Final steps verified and closed | None | Project is complete â€” no action required |

> **Visual:** [INSERT IMAGE: AMP dashboard showing projects with multiple status colors â€” red, green, teal, orange, and yellow visible]
...
Color is your first signal â€” it tells you the urgency and general state of a project at a glance. But color alone is never enough. Always read the full row.

**Red â€” Action Required**
Red is the most urgent status. A red status means the project cannot move forward until someone takes action. Red statuses (Revise, AIT Revise, Awaiting Revision) are always assigned to the Agent â€” the Jurisdiction has reviewed the submission and found something that must be corrected before review can continue.

> If you see red on the dashboard, find out who is responsible and what is needed. Do not leave red projects unattended.

**Teal / Cyan â€” Incomplete, Not Yet Submitted**
...
**Orange â€” Invoiced, Payment Required**
Orange means the invoice has been issued and payment is required before the project can proceed. After the May 2026 platform update, Agents can now fill out and save all components while payment is processing â€” but no component can be submitted for Jurisdiction review until payment is confirmed.

**Yellow â€” Pending, Monitor for Next Step**
Yellow means the project is moving through a step and is awaiting the next action in the workflow. Yellow projects are not stuck â€” they are in progress. Monitor them to ensure they advance on schedule and that the Shot Clock does not expire.

**Green â€” Approved or Complete**
...
The Shot Clock is not a suggestion â€” it is a federal legal requirement. If the Jurisdiction does not act before the Shot Clock expires:
...
> **For Jurisdiction Users:** Monitoring the Shot Clock is one of your most critical responsibilities in AMP. Letting a Shot Clock expire â€” even on a project with legitimate issues â€” can have serious legal consequences.
...
- The length of the Shot Clock varies by project type â€” SWF projects have different deadlines than Traditional Tower projects
...
Each column represents a different component or stage. A project can have one green column and one red column at the same time â€” meaning one part is approved while another requires immediate action. Reading only the green column would give you a completely false picture of the project's state.

### How to Read a Row Correctly

When you look at a project row on the dashboard, work through these questions in order:

1. **What is the overall project status?** â€” Check the leftmost status indicator
2. **What is the status of each component?** â€” Scan each component column left to right
3. **Are any components red?** â€” If yes, action is required immediately
4. **Are any components teal?** â€” If yes, something has been saved but not submitted
5. **What is the Shot Clock showing?** â€” Is there time pressure on this project?
6. **Who is responsible for the next step?** â€” Based on what you see, is it the Agent, Analyst, or Jurisdiction?

### Common Dashboard Mistakes

**Mistake 1 â€” Reading only one column**
A project can look approved in one column and be stuck in another. Always read the full row.

**Mistake 2 â€” Assuming teal means submitted**
...
**Mistake 3 â€” Ignoring yellow projects**
...
**Mistake 4 â€” Assuming green means everything is done**
...
**Mistake 5 â€” Not checking the Shot Clock**
The Shot Clock is easy to ignore â€” until it expires. Build a habit of checking Shot Clock values as part of every dashboard review.

> **Visual:** [INSERT IMAGE: Dashboard row with mixed statuses â€” one green, one red, one teal â€” demonstrating why the full row must be read]
...
- Every wireless facility application in AMP is organized as a **project** â€” the central unit of work in the system
- The **Dashboard** is the first screen after login â€” it provides a real-time view of all projects the user has access to
- **Agents see only their own projects**; Analysts and Clients see all projects within their jurisdiction
- There are **11 project statuses** â€” each with a specific color, meaning, and required action
- **Red = act now. Teal = not yet submitted. Orange = awaiting payment. Yellow = monitor. Green = approved/complete.**
- The **Shot Clock** is a federal countdown â€” if it expires, the application may be legally deemed approved
- **Never read status from a single column** â€” always scan the entire row left to right to understand the full picture

---

*End of Lesson 3 | Next: Lesson 4 â€” The Project Information Form (PIF)*
